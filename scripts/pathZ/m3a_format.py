...
M3A_PROMPT_PREFIX = (
    ...
    # r48: restore status. r43-r47 dropped it but model couldn't terminate
    # → over-acted on tasks like "take 1 photo" (took 5). Now reintroduced
    # so the model can signal "task complete" when env state matches goal.
